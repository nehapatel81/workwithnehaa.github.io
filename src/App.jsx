...
const TOPMATE_BOOKING_URL = "https://topmate.io/workwithnehaaa";
...
const PORTFOLIO = [
  { cat: "Web", title: "Bloom Boutique", sub: "E-Commerce & Brand Identity", color: "#f3d5d5", accent: "#c07676", image: "img/bloomboutique.jpg" },
  { cat: "Social", title: "Thrive Coaching", sub: "Social Media Strategy & Design", color: "#ddd5f0", accent: "#8b76c0", image: "img/thrivecoaching.jpg" },
  { cat: "Video", title: "Luxe Skincare", sub: "Product Reels & Video Campaign", color: "#d5e8d5", accent: "#6ca06c", image: "img/luxuryskincarevideo.mp4" },
  { cat: "Web", title: "StartupLaunch Co.", sub: "Full Stack Web App", color: "#f0e5d5", accent: "#c09060", image: "img/startuplaunchco.jpg" },
  { cat: "SEO", title: "Local Bakehouse", sub: "Local SEO & Content Strategy", color: "#d5edf0", accent: "#60a0a8", image: "img/localbakehouse.jpg" },
  { cat: "Branding", title: "Aria Wellness", sub: "Brand Identity & Design System", color: "#f0d5e8", accent: "#b068a0", image: "img/ariawellness.jpg" },
];
...
const TESTIMONIALS = [
  { name: "Emma Thompson", role: "Founder, Bloom Boutique", quote: "Neha transformed our online presence completely. Our website now genuinely reflects our brand, and bookings have increased by 180% since the redesign.", avatar: "PS" },
  { name: "Lucas Anderson", role: "Business Coach & Speaker", quote: "She doesn't just build websites — she builds experiences. Every detail was intentional, every pixel perfect. My clients keep complimenting my site.", avatar: "AM" },
  { name: "Daniel Müller", role: "CEO, StartupLaunch Co.", quote: "Professional, creative, and always ahead of deadlines. Neha delivered a full-stack platform that our team loves working with daily.", avatar: "RK" },
  { name: "Olivia Chen", role: "Lifestyle Brand, Aria Wellness", quote: "From logo to website to Instagram — Neha handled everything. It felt like having a full creative agency, but so much more personal and caring.", avatar: "SP" },
];
...
function LinkIcon() {
  return (
    <svg width="17" height="17" viewBox="0 0 24 24" fill="none" aria-hidden="true">
      <path d="M10 13a5 5 0 0 0 7.1 0l2-2a5 5 0 0 0-7.1-7.1l-1.1 1.1" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M14 11a5 5 0 0 0-7.1 0l-2 2a5 5 0 0 0 7.1 7.1l1.1-1.1" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
function CalendarIcon() {
  return (
    <svg width="17" height="17" viewBox="0 0 24 24" fill="none" aria-hidden="true">
      ...
      <path d="M8 14h3M8 17h6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
    </svg>
  );
}
...
export default function App() {
  ...
  const openBooking = () => window.open(TOPMATE_BOOKING_URL, "_blank", "noopener,noreferrer");
    ...
    <div style={{ fontFamily: "'Cormorant Garamond', 'Playfair Display', Georgia, serif", background: bg, color: text, minHeight: "100vh", overflowX: "hidden", transition: "background 0.4s, color 0.4s" }}>
      ...
      <nav style={{
        ...
        <div className="desktop-nav" style={{ display: "flex", gap: "2rem", alignItems: "center" }}>
          ...
          <button className="btn-primary" style={{ padding: "0.6rem 1.4rem", fontSize: "0.78rem" }} onClick={openBooking}>Book a Call</button>
      ...
      {menuOpen && (
        <div style={{ position: "fixed", inset: 0, zIndex: 99, background: dark ? "rgba(15,10,13,0.97)" : "rgba(253,248,245,0.97)", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: "2rem" }}>
          ...
          <button className="btn-primary" onClick={openBooking}>Book a Call</button>
        </div>
      )}
      ...
      <section id="hero" style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", position: "relative", overflow: "hidden", paddingTop: "5rem" }}>
          ...
          <div style={{ display: "flex", justifyContent: "center", alignItems: "center", position: "relative" }}>
            <div className="hero-image" style={{ position: "relative" }}>
              ...
              <div style={{ width: "320px", height: "380px", borderRadius: "40% 60% 55% 45% / 45% 45% 55% 55%", background: dark ? "linear-gradient(135deg, #3a1a2a, #2a1a3a)" : "linear-gradient(135deg, #f5ddd5, #e8d5f0)", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", position: "relative", overflow: "hidden", boxShadow: "0 30px 80px rgba(180,100,140,0.3)", border: "2px solid rgba(200,150,160,0.3)" }}>
               ...
               <div style={{ position: "absolute", bottom: "90px", left: "-100px", background: "linear-gradient(135deg, #c07878, #9a5a9a)", borderRadius: "14px", padding: "0.6rem 1rem", boxShadow: "0 10px 30px rgba(180,100,120,0.4)", color: "#fff" }}>
                <div style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "0.7rem", opacity: 0.8, letterSpacing: "0.08em" }}>✦ OPEN TO CLIENTS</div>
                <div style={{ fontSize: "0.85rem", fontWeight: 700 }}>⭐ As Always</div>
              </div>
        ...
        <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, overflow: "hidden", borderTop: `1px solid ${border}`, padding: "0.9rem 0", background: dark ? "rgba(255,255,255,0.02)" : "rgba(255,255,255,0.4)", backdropFilter: "blur(10px)" }}>
          <div className="marquee-track" style={{ gap: "3rem" }}>
            {[...Array(2)].map((_, i) => (
              ["150+ Projects", "✦" , "7+years", "◈", "98% Clients Happy", "◉" ,"Social Media", "◈", "Video Editing", "◉", "SEO & Branding", "⬡", "Content Creation", "◎", "WordPress", "▷", "React Development", "✦", "Digital Strategy", "◈", "Reels & Video", "◉"].map((t, j) => (
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "5rem", alignItems: "center" }}>
          <AnimSection>
            <div style={{ position: "relative" }}>
              ...
              <div style={{ position: "absolute", bottom: "-10px", right: "-20px", background: "linear-gradient(135deg, #c07878, #9a5a9a)", borderRadius: "20px", padding: "1.5rem 2rem", boxShadow: "0 20px 50px rgba(180,100,120,0.4)", color: "#fff" }}>
      ...
      <section id="services" style={{ padding: "7rem 2rem", background: dark ? "rgba(255,255,255,0.02)" : "rgba(250,240,235,0.6)" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <AnimSection style={{ textAlign: "center", marginBottom: "4rem" }}>
            ...
            <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "1rem", color: muted, maxWidth: "740px", margin: "0 auto", lineHeight: 1.8, paddingBottom:"40px" }}>One studio. Every digital service your business needs to look premium and grow consistently.</p>
          </AnimSection>
          ...
          {filtered.map((p, i) => (
            <AnimSection key={p.title} delay={i * 0.08}>
              <div className="glass-card" style={{ overflow: "hidden", cursor: "pointer" }}>
                <div style={{ height: "200px", position: "relative", display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden" }}>
                  {p.image ? (
                    p.image.toLowerCase().endsWith(".mp4") ? (
                      <video
                        src={p.image}
                        autoPlay
                        muted
                    ...
                    <div style={{ width: "100%", height: "100%", background: `linear-gradient(135deg, ${p.color}, ${p.color}cc)`, display: "flex", alignItems: "center", justifyContent: "center" }}>
                      <div style={{ textAlign: "center", color: p.accent, position: "relative", zIndex: 1 }}>
                        <div style={{ fontSize: "3rem", marginBottom: "0.5rem" }}>🖼️</div>
                        <div style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "0.75rem", letterSpacing: "0.12em", textTransform: "uppercase", fontWeight: 600 }}>{p.cat}</div>
                      </div>
                    </div>
                  )}
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "5rem", alignItems: "start" }}>
          <AnimSection>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "1.2rem", marginBottom: "2.5rem" }}>
              {[
                { icon: "✉️", label: "Email", val: "workwithnehaa15@gmail.com" },
                { icon: "📍", label: "Location", val: "Available Worldwide - Remote" },
               // { icon: "📞", label: "Phone", val: "+91 9106547967" },
              ].map(c => (
            ...
            <div style={{ display: "flex", gap: "0.75rem" }}>
              {[
                { label: "in", href: "https://www.linkedin.com/in/nehapatel81/", title: "LinkedIn" },
                { label: "Instagram", icon: <InstagramIcon />, href: "https://www.instagram.com/workwithnehaaa/", title: "Instagram" },
                //{ label: "𝕏", href: "#", title: "Twitter/X" },
                //{ label: "▶", href: "#", title: "YouTube" },
                { label: "Topmate", icon: <CalendarIcon />, href: "https://topmate.io/workwithnehaaa", title: "Topmate" },
                { label: "Bacon.io", icon: <LinkIcon />, href: "https://beacons.ai/workwithnehaaa", title: "Bacon.io" },
                //{ label: "Be", href: "#", title: "Behance" },
              ].map(s => (
                <a key={s.title} href={s.href} target="_blank" rel="noopener noreferrer" className="social-icon" style={{ color: muted, textDecoration: "none", fontFamily: "'DM Sans',sans-serif", fontWeight: 700, fontSize: "0.9rem" }} title={s.title}>{s.icon ?? s.label}</a>
              ))}
            </div>
          </AnimSection>
            ...
            <div className="glass-card" style={{ padding: "2.5rem" }}>
              ...
              {submitted ? (
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
                  ...
                  <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "0.75rem", color: muted, textAlign: "center" }}>Or book directly via <span style={{ color: "#c07878", cursor: "pointer", textDecoration: "underline" }}>Topmate</span></p>
                </div>
              )}
            </div>
          </AnimSection>
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr 1fr", gap: "3rem", marginBottom: "3rem" }}>
            ...
            <div>
              ...
              <div style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "0.88rem", color: muted, marginBottom: "0.5rem" }}>workwithnehaa15@gmail.com</div>
             <div style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "0.88rem", color: muted, marginBottom: "1.5rem" }}></div>
                ...
                {[
                 ...
                 //{ label: "𝕏", href: "#", title: "Twitter/X" },
                  ...
                  <a
                    ...
                    style={{ width: 36, height: 36, color: muted, fontFamily: "'DM Sans',sans-serif", fontWeight: 700, fontSize: "0.85rem" }}
                    title={s.title}
                  >
                    {s.icon ?? s.label}
                  </a>
          ...
          <div style={{ borderTop: `1px solid ${border}`, paddingTop: "1.5rem", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "1rem" }}>
            <div style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "0.8rem", color: muted }}>© 2026 Neha Patel. All rights reserved. Crafted with ✦ passion.</div>
